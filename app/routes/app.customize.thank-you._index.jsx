...
import { Truck, MessageCircle, PackageSearch, Gift, ShoppingBag, Star, Share2, RotateCcw, XCircle, ShieldCheck, RefreshCw } from "lucide-react";

const ICONS = { Truck, MessageCircle, PackageSearch, Gift, ShoppingBag, Star, Share2, RotateCcw, XCircle, ShieldCheck, RefreshCw };
const BLOCK_TYPES = Object.keys(BLOCK_REGISTRY).filter((type) =>
    BLOCK_REGISTRY[type].pages.includes("thank-you")
);
...
export default function CustomizeThankYou() {
    ...
    return (
        <s-page inlineSize="large" heading="Thank You">
            <s-section>
                                    ...
                                    <s-box padding="small" background="subdued" borderRadius="base" key={item.blockType}>
                                        <s-stack direction="block" gap="small-100">
                                            ...
                                            <s-stack direction="inline" justifyContent="space-between" alignItems="center" gap="small">
                                                ...
                                                <s-button variant="secondary" icon="adjust" href={`/app/customize/thank-you/${meta.slug}/edit`}>
                                                    Configure
                                                </s-button>
                                            </s-stack>
                                        </s-stack>
